...
bash ./build-linux.sh "${IMAGE_TAG}"
echo "✅ Local build completed"
echo ""

if ! docker image inspect "${LOCAL_IMAGE_NAME}:${IMAGE_TAG}" >/dev/null 2>&1; then
  echo "ERROR: Expected local image ${LOCAL_IMAGE_NAME}:${IMAGE_TAG} not found."
